...
class pascal_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        # 将数据文件保存在仓库之外的位置
        self._devkit_path = cfg.DATA_DIR
        #self._devkit_path = '/workspace/ctpn_data/VOCdevkit/'
        #self._devkit_path = '/home/leo/PythonProjects/CHINESE-OCR/CHINESE-OCR_workspace/ctpn_data/VOCdevkit/'
